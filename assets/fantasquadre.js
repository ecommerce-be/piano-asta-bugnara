...
import { caricaDati, ricalcola, badgeRuolo, asta, gestisce, RUOLI } from './app.js?v=9';
import {
  avvia, configurato, collegato, utente, leggi, scrivi, osserva,
  montaAccesso, esc, quando,
} from './db.js?v=9';
import { chiediCampi, conferma as chiediConferma, autosalva, toast } from './ui.js?v=9';
